...
.contant {
   position:relative;
   z-index:99;
   box-shadow: 10px 10px 35px 5px #888888;
    border-radius: 15px;
    /* box-shadow: 0 0 3px #888888; */
    /* background: url(../images/login_input_area_bg.png) center center no-repeat; */
...
.btn-login button{
  ...
  width: 295px;
  height: 40px;
  background-color: rgb(94, 194, 166);
  /* border: 1px solid; */
  border-radius: 5px;
}
.forget{
    ...
    <div class="bgimg">
        <div class="login_area">
          <div class="contant">
              ...
              <p class="input-login">
                <label>账号</label>
                <input v-model="user_name" placeholder="账号" ></input>
              </p>
              <p  class="input-login">
                <label>密码</label>
                <input v-model="password" placeholder="密码"></input><br/>
                <span  class="forget">忘记密码？</span>
              </p>
              <p class="btn-login">
                <Button type="success" v-on:click="send_login">登录</Button><br/><br/>
                <span class="regin-now">还没有账号？</span><span  class="forget " @click.native="changeMod('regin')">立即注册</span>
                <!-- v-on:click="send_register"  -->
              </p>
              <div class="horizontal_line"></div>
              <p class="welcome-user">欢迎使用拇指跳动平台</p>
